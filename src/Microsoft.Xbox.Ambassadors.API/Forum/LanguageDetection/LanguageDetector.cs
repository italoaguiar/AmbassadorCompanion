...
namespace LanguageDetection
{
    internal class LanguageDetector
    {
        ...
        private const string ResourceNamePrefix = "Microsoft.Xbox.Ambassadors.API.Forum.LanguageDetection.Profiles.";
        ...
        {
            AddLanguages(GetType().GetTypeInfo().Assembly.GetManifestResourceNames()
